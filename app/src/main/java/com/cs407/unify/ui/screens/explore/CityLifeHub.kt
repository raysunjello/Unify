...
@Composable
fun CityLifePage(onExit: () -> Unit, onClick: (Thread) -> Unit) {
    var transportHub by remember { mutableStateOf(ThreadStore.getSavedThreads()) } // TODO : change
    ...
    Surface(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "CITY LIFE", // TODO : replace with string
                    style = MaterialTheme.typography.headlineMedium,
                    fontWeight = FontWeight.Bold
                )

                when {
                    transportHub.isEmpty() -> {
                        Text(
                            text = "No Posts",
